...
API_TOKEN = 7107129618:AAE7_i21ZrdTZCgcsyYXuHRlTDxS8RTmQBM
ADMIN_ID = 1002226478062
MAX_RESTARTS = 5
RESTART_PERIOD = 60  # Seconds

logging.basicConfig(level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
bot = Bot 7107129618:AAE7_i21ZrdTZCgcsyYXuHRlTDxS8RTmQBM
...
async def notify_admin(message):
    ...
    try:
        await bot.send_message(1002226478062, message)
